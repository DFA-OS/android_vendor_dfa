...
ALARM_PATH := vendor/dfa/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dfa/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dfa/prebuilt/common/media/audio/ringtones
